...
from delfi.kernel.BaseKernel import BaseKernel, BaseNoneKernel
...
class HalfGauss(BaseNoneKernel):
    def __init__(self, obs, bandwidth=1., atleast=None, nan_weight=0.0):
